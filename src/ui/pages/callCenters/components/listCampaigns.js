...
const LinkToCampaign = ({ campaignName, campaignId }) => (
    <Link to={campaignId} underline="hover">
        {campaignName}
    </Link>
);
                        ...
                        <>
                            {campaign.id !== null && (
                                <StyledListItem key={campaign.id} divider>
                                    <ListItemText
                                        primary={<LinkToCampaign campaignName={campaign.name} campaignId={campaign.id} />}
                                        secondary={
